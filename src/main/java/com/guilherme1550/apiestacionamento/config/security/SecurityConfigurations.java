...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.PUT,"/empresas/**" ).hasAnyRole("USUARIO_EMPRESA_ADM", "USUARIO_EMPRESA")
			.antMatchers(HttpMethod.DELETE,"/empresas/**" ).hasRole("USUARIO_EMPRESA_ADM")
			.antMatchers(HttpMethod.POST,"/veiculos" ).hasAnyRole("USUARIO_EMPRESA_ADM", "USUARIO_EMPRESA")
			.antMatchers(HttpMethod.GET,"/veiculos/**" ).hasAnyRole("USUARIO_EMPRESA_ADM", "USUARIO_EMPRESA")
			.antMatchers(HttpMethod.PATCH,"/veiculos/**" ).hasAnyRole("USUARIO_EMPRESA_ADM", "USUARIO_EMPRESA")
			.antMatchers(HttpMethod.DELETE,"/veiculos/**" ).hasAnyRole("USUARIO_EMPRESA_ADM")
